...
Pour \appName, nous avons voulu adopté un style graphique qui permettrait au différents éléments de se détacher de l’aspect flat design général utilisé sur l’application.

L’idée retenue parmi tous les styles testés, fus des dessins à l’aspect graphique crayonner ou « Draft ».
...
\chapter{Conclusion}
\octopusName was a very interesting experience for the learning of new development technology and for the creativity that we have developed in the application.But the development was not easy and we have a lot of difficult to find an idea for the application.
